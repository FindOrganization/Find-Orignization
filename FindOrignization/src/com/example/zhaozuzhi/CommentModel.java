...
public class CommentModel implements Serializable{
	...
	private ArrayList<CommentModel> subComment = new ArrayList<CommentModel>();
	 ...
	 */
	public CommentModel(int user_id,int masterid , int sid, String title, String subject,Date the_date,double lon,double lat, String userName)
	{   
     ...
     */
	public void setSubComment(ArrayList<CommentModel> subComments)
	{
	 ...
	 * the subcomment list
	 */
	public ArrayList<CommentModel> getSubComment()
	{
		return subComment;
	}
	...
	public void setMaster_ID(int master_ID) {
		this.master_comment_ID = master_ID;
	}
